...
import com.nekoimi.standalone.framework.error.exception.IdGeneratorSystemClockException;
import lombok.extern.slf4j.Slf4j;

/**
 * @author Nekoimi  2020/6/1 上午9:39
 *
 * <p>雪花算法ID生成 (每秒生成～100万不重复ID)</p>
 *
 * <p>length: 64位
 *      - 1bit => 0 (头部默认保留位)
 *      - 41bit => 时间戳
...
public class SnowflakeIdGenerator implements IdentifierGenerator {
    ...
    public String nextUUID(Object entity) {
        return SecureUtil.md5(genId().toString());
    }
}
